...
from .views import HotelViewSet, DocumentViewSet, GalleryViewSet, FeatureViewSet, RoomTypeViewSet, RoomViewSet, FAQViewSet, BookingsViewAdmin, ReservationCreateView, ReservationView
