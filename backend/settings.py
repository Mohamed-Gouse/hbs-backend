...
SECRET_KEY = 'django-insecure-kimexex^lhhv7i^)x$z-c0_sjcmytewv%c(sxr-_26@n&sby=5'

DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1:8000", "backend.jb-computers.shop"]
...
INSTALLED_APPS = [
    ...
    'hotel_side.apps.HotelSideConfig',
...
AUTH_USER_MODEL = 'auth_app.Accounts'
...
PASSWORD_RESET_TIMEOUT = timedelta(minutes=1).total_seconds()
